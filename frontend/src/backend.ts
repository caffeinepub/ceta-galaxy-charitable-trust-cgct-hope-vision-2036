...
import type { ExternalBlob as _ExternalBlob, NewPhoto as _NewPhoto, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async deletePhoto(arg0: NewPhotoId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllPhotos(): Promise<Array<NewPhoto>> {
        if (this.processError) {
            try {
    ...
    async getSubscriptionCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getSubscriptionCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitSubscription(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async uploadPhoto(arg0: ExternalBlob, arg1: string | null): Promise<NewPhotoId> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadPhoto(await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n19(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_NewPhoto_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _NewPhoto): Promise<NewPhoto> {
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_NewPhoto>): Promise<Array<NewPhoto>> {
    return await Promise.all(value.map(async (x)=>await from_candid_NewPhoto_n11(_uploadFile, _downloadFile, x)));
}
