...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "hero.headline2":
      "Empowering Excellence. Expanding Impact. Shaping the Next Decade of HOPE.",
    "hero.subheading":
      "CGCT completes 15 impactful years. Now we build the next decade of empowerment.",
    ...
    "about.p1":
      "CETA Galaxy Charitable Trust (CGCT) was born in 2011 as a byproduct of the CETA Global Meet 2010 held in Dubai, with a vision to bring together the experience and expertise of Engineers from CET for the betterment of our society.",
    "about.p2":
      "HOPE – Helping Outstanding Pupils in Education – the flagship project of CGCT, was launched in 2011 with the vision of giving back to society.",
    "about.p3":
      "Over 15 years, CGCT has built a structured and evolving ecosystem of academic, career, and personal empowerment initiatives. As we move on to the next decade, CGCT is reviewing its policies and programs with the intention of reaching out to the weaker sections of society at large, without compromising on the quality of output.",
    "about.timeline.title": "Our Journey",
    "about.timeline.2010": "HOPE Launched",
    "about.timeline.2010.desc":
      "Born from CETA Global Meet 2010, Dubai. HOPE program launched in 2011 to support outstanding students.",
    "about.timeline.2016": "HOPE CARES",
    "about.timeline.2016.desc":
      "Launched HOPE CARES in 2016 for holistic empowerment and community care initiatives.",
    "about.timeline.2017": "HOPE Plus",
    "about.timeline.2017.desc":
      "HOPE Plus launched in 2017 with expanded mentorship, career guidance, and alumni volunteer network.",
    "about.timeline.2026": "Vision 2036",
    "about.timeline.2026.desc":
      "Strategic transformation — Vision 2036 launched for the next decade of impact.",
    "about.chairman": "Chairman",
    "about.chairman.name": "Satheesh Kumar V",
    "about.chairman.quote":
      '"Together, we have built 15 years of hope. Together, we will shape the next decade of transformation."',
    ...
    "reunion.subheading":
      "Join us for a memorable gathering celebrating friendship, shared journeys, and new beginnings as HOPE alumni come together once again.",
    "reunion.date": "12 April 2026",
    "reunion.venue": "KILA, Thrissur",
    "reunion.time": "9:00 AM – 5:00 PM",
    "reunion.meetings":
      "Two virtual preparatory meetings completed: 7 February 2026 & 25 February 2026",
    ...
    "reunion.cat.c":
      "Entered HOPE Plus but could not complete for various reasons",
    "reunion.cat.d": "Completed HOPE Plus & active as HOPE Volunteer",
    "reunion.cat.e":
      "Other volunteers associated with HOPE and CGCT initiatives",
    ...
    "reunion.note":
      "This is the FIRST HOPE ALUMNI REUNION — a celebration, not a camp!",

    // Survey
    "survey.title": "CGCT Vision 2036 Survey",
    "survey.headline": "Your Ideas. Your Voice. Your Vision.",
    "survey.subheading":
      "Help shape the next decade of CGCT's impact. Your responses are completely confidential.",
    "survey.confidential": "🔒 All responses are strictly confidential",
    "survey.participate":
      "All HOPE alumni are encouraged to participate and share their vision for 2036.",
    ...
    "stakeholder.item1.desc":
      "Proposed reforms to make scholarship selection more empathetic, merit-based, and inclusive of diverse backgrounds.",
    "stakeholder.item2.title": "Observation Year Proposal",
    "stakeholder.item2.desc":
      "A new Observation Year framework proposed for HOPE selection (Grade 7 Reserve List model) to help students transition smoothly — this applies to HOPE, not HOPE Plus.",
    "stakeholder.item3.title": "Alumni-Led Committees",
    "stakeholder.item3.desc":
      "Formation of profession-based advisory committees led by experienced HOPE alumni to guide current students.",
    "stakeholder.item4.title": "Placement Cell Formation",
    "stakeholder.item4.desc":
      "Dedicated placement cell to be established for HOPE Plus students, connecting them with industry opportunities.",
    "stakeholder.item5.title": "Newsletter Launch",
    "stakeholder.item5.desc":
      "Launch of a regular CGCT newsletter to keep alumni informed, engaged, and connected to the mission.",
    "stakeholder.item6.title": "Alumni Database Update",
    "stakeholder.item6.desc":
      "Comprehensive update of the alumni database to track career progress and enable targeted support.",

    // Planning Meeting
    "stakeholder.planning.title":
      "HOPE Alumni Reunion 2026 – Planning Meeting (25 February 2026)",
    "stakeholder.planning.subtitle":
      "Key decisions and progress from the second preparatory meeting",
    "stakeholder.planning.item1": "KILA venue booked for 140 participants",
    "stakeholder.planning.item2":
      "Registration form and official poster released",
    "stakeholder.planning.item3":
      "200+ alumni contacts collected across districts",
    "stakeholder.planning.item4":
      "Publicity strengthening through reels, posters, direct outreach",
    "stakeholder.planning.item5":
      "Formation of communication groups/broadcast channels",
    ...
    "stakeholder.planning.item8":
      "Official website and Instagram platform development",
    ...
    "digital.item1.desc":
      "A regular digital newsletter to keep all HOPE alumni informed about events, opportunities, and success stories.",
    "digital.item2.title": "Alumni Brand Ambassadors",
    "digital.item2.desc":
      "Empowering successful alumni to become brand ambassadors, inspiring the next generation of HOPE students.",
    "digital.item3.title": "School Liaison Network",
    "digital.item3.desc":
      "Building a network of school liaisons to identify and support outstanding students from underserved communities.",
    "digital.item4.title": "WhatsApp & Email Strategy",
    "digital.item4.desc":
      "Structured communication strategy using WhatsApp groups and email campaigns to keep alumni engaged and informed.",
    ...
    "footer.newsletter.desc":
      "Subscribe to receive updates on CGCT events, alumni news, and Vision 2036 progress.",
    "footer.newsletter.placeholder": "Your email address",
    "footer.newsletter.btn": "Subscribe",
    "footer.newsletter.success": "Thank you for subscribing!",
    "footer.copyright":
      "© 2026 CETA Galaxy Charitable Trust. All rights reserved.",
  ...
  ml: {
    ...
    "hero.headline2":
      "മികവ് ശക്തിപ്പെടുത്തുക. ആഘാതം വിപുലീകരിക്കുക. HOPE-ന്റെ അടുത്ത ദശകം രൂപപ്പെടുത്തുക.",
    "hero.subheading":
      "CGCT 15 ഫലപ്രദമായ വർഷങ്ങൾ പൂർത്തിയാക്കുന്നു. ഇപ്പോൾ നാം ശാക്തീകരണത്തിന്റെ അടുത്ത ദശകം കെട്ടിപ്പടുക്കുന്നു.",
    ...
    "about.p1":
      "CETA ഗാലക്സി ചാരിറ്റബിൾ ട്രസ്റ്റ് (CGCT) 2011-ൽ ദുബായിൽ നടന്ന CETA ഗ്ലോബൽ മീറ്റ് 2010-ന്റെ ഉൽപ്പന്നമായി ജനിച്ചു.",
    "about.p2":
      "HOPE – ഹെൽപ്പിംഗ് ഔട്ട്സ്റ്റാൻഡിംഗ് പ്യൂപ്പിൾസ് ഇൻ എഡ്യൂക്കേഷൻ – CGCT-യുടെ പ്രധാന പദ്ധതി, 2011-ൽ സമൂഹത്തിന് തിരിച്ചുനൽകുക എന്ന ദർശനത്തോടെ ആരംഭിച്ചു.",
    "about.p3":
      "15 വർഷങ്ങളിൽ, CGCT അക്കാദമിക്, കരിയർ, വ്യക്തിഗത ശാക്തീകരണ സംരംഭങ്ങളുടെ ഒരു ഘടനാപരമായ ആവാസവ്യവസ്ഥ കെട്ടിപ്പടുത്തു.",
    "about.timeline.title": "ഞങ്ങളുടെ യാത്ര",
    "about.timeline.2010": "HOPE ആരംഭിച്ചു",
    "about.timeline.2010.desc":
      "CETA ഗ്ലോബൽ മീറ്റ് 2010, ദുബായിൽ നിന്ന് ജനിച്ചു. HOPE പ്രോഗ്രാം 2011-ൽ മികച്ച വിദ്യാർത്ഥികളെ പിന്തുണയ്ക്കാൻ ആരംഭിച്ചു.",
    "about.timeline.2016": "HOPE CARES",
    "about.timeline.2016.desc":
      "സമഗ്ര ശാക്തീകരണത്തിനും കമ്മ്യൂണിറ്റി കെയർ സംരംഭങ്ങൾക്കുമായി 2016-ൽ HOPE CARES ആരംഭിച്ചു.",
    "about.timeline.2017": "HOPE Plus",
    "about.timeline.2017.desc":
      "HOPE Plus 2017-ൽ വിപുലീകൃത മെന്റർഷിപ്പ്, കരിയർ ഗൈഡൻസ്, അലുംനി വോളണ്ടിയർ നെറ്റ്‌വർക്ക് എന്നിവയോടെ ആരംഭിച്ചു.",
    "about.timeline.2026": "വിഷൻ 2036",
    "about.timeline.2026.desc":
      "തന്ത്രപരമായ പരിവർത്തനം — ആഘാതത്തിന്റെ അടുത്ത ദശകത്തിനായി വിഷൻ 2036 ആരംഭിച്ചു.",
    "about.chairman": "ചെയർമാൻ",
    "about.chairman.name": "സതീഷ് കുമാർ വി",
    "about.chairman.quote":
      '"ഒരുമിച്ച്, നാം 15 വർഷത്തെ പ്രതീക്ഷ കെട്ടിപ്പടുത്തു. ഒരുമിച്ച്, നാം പരിവർത്തനത്തിന്റെ അടുത്ത ദശകം രൂപപ്പെടുത്തും."',
    ...
    "reunion.subheading":
      "HOPE അലുംനി ഒരുമിച്ചുകൂടുന്ന ഒരു അവിസ്മരണീയ സമ്മേളനത്തിൽ ഞങ്ങളോടൊപ്പം ചേരുക.",
    "reunion.date": "12 ഏപ്രിൽ 2026",
    "reunion.venue": "KILA, തൃശ്ശൂർ",
    "reunion.time": "രാവിലെ 9:00 – വൈകുന്നേരം 5:00",
    "reunion.meetings":
      "രണ്ട് വെർച്വൽ തയ്യാറെടുപ്പ് മീറ്റിംഗുകൾ പൂർത്തിയായി: 7 ഫെബ്രുവരി 2026 & 25 ഫെബ്രുവരി 2026",
    ...
    "reunion.cat.c":
      "HOPE Plus-ൽ പ്രവേശിച്ചു എന്നാൽ വിവിധ കാരണങ്ങളാൽ പൂർത്തിയാക്കാൻ കഴിഞ്ഞില്ല",
    "reunion.cat.d": "HOPE Plus പൂർത്തിയാക്കി & HOPE വോളണ്ടിയറായി സജീവം",
    "reunion.cat.e": "HOPE, CGCT സംരംഭങ്ങളുമായി ബന്ധപ്പെട്ട മറ്റ് വോളണ്ടിയർമാർ",
    ...
    "survey.subheading":
      "CGCT-യുടെ ആഘാതത്തിന്റെ അടുത്ത ദശകം രൂപപ്പെടുത്താൻ സഹായിക്കുക. നിങ്ങളുടെ പ്രതികരണങ്ങൾ പൂർണ്ണമായും രഹസ്യമാണ്.",
    "survey.confidential": "🔒 എല്ലാ പ്രതികരണങ്ങളും കർശനമായി രഹസ്യമാണ്",
    "survey.participate":
      "എല്ലാ HOPE അലുംനിയും 2036-നുള്ള തങ്ങളുടെ വിഷൻ പങ്കിടാൻ പ്രോത്സാഹിപ്പിക്കപ്പെടുന്നു.",
    ...
    "stakeholder.item1.desc":
      "സ്കോളർഷിപ്പ് തിരഞ്ഞെടുപ്പ് കൂടുതൽ സഹാനുഭൂതിയോടെ, മെറിറ്റ് അടിസ്ഥാനത്തിൽ, വൈവിധ്യമാർന്ന പശ്ചാത്തലങ്ങൾ ഉൾക്കൊള്ളുന്ന രീതിയിൽ ആക്കാൻ നിർദ്ദേശിക്കപ്പെട്ട പരിഷ്കാരങ്ങൾ.",
    "stakeholder.item2.title": "നിരീക്ഷണ വർഷ നിർദ്ദേശം",
    "stakeholder.item2.desc":
      "HOPE തിരഞ്ഞെടുപ്പിനായി ഒരു പുതിയ നിരീക്ഷണ വർഷ ചട്ടക്കൂട് നിർദ്ദേശിക്കപ്പെട്ടു.",
    "stakeholder.item3.title": "അലുംനി നേതൃത്വ സമിതികൾ",
    "stakeholder.item3.desc":
      "നിലവിലെ വിദ്യാർത്ഥികളെ നയിക്കാൻ പരിചയസമ്പന്നരായ HOPE അലുംനി നേതൃത്വം നൽകുന്ന തൊഴിൽ അടിസ്ഥാനത്തിലുള്ള ഉപദേശക സമിതികളുടെ രൂപീകരണം.",
    "stakeholder.item4.title": "പ്ലേസ്മെന്റ് സെൽ രൂപീകരണം",
    "stakeholder.item4.desc":
      "HOPE Plus വിദ്യാർത്ഥികൾക്കായി ഒരു സമർപ്പിത പ്ലേസ്മെന്റ് സെൽ സ്ഥാപിക്കും.",
    "stakeholder.item5.title": "ന്യൂസ്‌ലെറ്റർ ലോഞ്ച്",
    "stakeholder.item5.desc":
      "അലുംനിയെ അറിയിക്കാനും ഇടപഴകാനും ദൗത്യവുമായി ബന്ധിപ്പിക്കാനും ഒരു പതിവ് CGCT ന്യൂസ്‌ലെറ്ററിന്റെ ലോഞ്ച്.",
    "stakeholder.item6.title": "അലുംനി ഡേറ്റാബേസ് അപ്ഡേറ്റ്",
    "stakeholder.item6.desc":
      "കരിയർ പുരോഗതി ട്രാക്ക് ചെയ്യാനും ലക്ഷ്യബോധമുള്ള പിന്തുണ സാധ്യമാക്കാനും അലുംനി ഡേറ്റാബേസിന്റെ സമഗ്ര അപ്ഡേറ്റ്.",

    // Planning Meeting
    "stakeholder.planning.title":
      "HOPE അലുംനി റീയൂണിയൻ 2026 – ആസൂത്രണ മീറ്റിംഗ് (25 ഫെബ്രുവരി 2026)",
    "stakeholder.planning.subtitle":
      "രണ്ടാം തയ്യാറെടുപ്പ് മീറ്റിംഗിൽ നിന്നുള്ള പ്രധാന തീരുമാനങ്ങളും പുരോഗതിയും",
    ...
    "stakeholder.planning.item4":
      "റീലുകൾ, പോസ്റ്ററുകൾ, നേരിട്ടുള്ള ഔട്ട്‌റീച്ച് വഴി പ്രചാരണം ശക്തിപ്പെടുത്തൽ",
    ...
    "digital.item1.desc":
      "ഇവന്റുകൾ, അവസരങ്ങൾ, വിജയഗാഥകൾ എന്നിവയെക്കുറിച്ച് എല്ലാ HOPE അലുംനിയെയും അറിയിക്കാൻ ഒരു പതിവ് ഡിജിറ്റൽ ന്യൂസ്‌ലെറ്റർ.",
    "digital.item2.title": "അലുംനി ബ്രാൻഡ് അംബാസഡർമാർ",
    "digital.item2.desc":
      "HOPE വിദ്യാർത്ഥികളുടെ അടുത്ത തലമുറയ്ക്ക് പ്രചോദനം നൽകാൻ വിജയകരമായ അലുംനിയെ ബ്രാൻഡ് അംബാസഡർമാരാക്കൽ.",
    "digital.item3.title": "സ്കൂൾ ലൈസൺ നെറ്റ്‌വർക്ക്",
    "digital.item3.desc":
      "സേവനം ലഭിക്കാത്ത കമ്മ്യൂണിറ്റികളിൽ നിന്ന് മികച്ച വിദ്യാർത്ഥികളെ തിരിച്ചറിഞ്ഞ് പിന്തുണയ്ക്കാൻ സ്കൂൾ ലൈസൺ നെറ്റ്‌വർക്ക് കെട്ടിപ്പടുക്കൽ.",
    "digital.item4.title": "WhatsApp & ഇമെയിൽ തന്ത്രം",
    "digital.item4.desc":
      "അലുംനിയെ ഇടപഴകിക്കാനും അറിയിക്കാനും WhatsApp ഗ്രൂപ്പുകളും ഇമെയിൽ കാമ്പെയ്‌നുകളും ഉപയോഗിക്കുന്ന ഘടനാപരമായ ആശയവിനിമയ തന്ത്രം.",
    ...
    "footer.newsletter.desc":
      "CGCT ഇവന്റുകൾ, അലുംനി വാർത്തകൾ, വിഷൻ 2036 പുരോഗതി എന്നിവയെക്കുറിച്ചുള്ള അപ്‌ഡേറ്റുകൾ ലഭിക്കാൻ സബ്‌സ്‌ക്രൈബ് ചെയ്യുക.",
    ...
    "footer.copyright":
      "© 2026 CETA ഗാലക്സി ചാരിറ്റബിൾ ട്രസ്റ്റ്. എല്ലാ അവകാശങ്ങളും നിക്ഷിപ്തം.",
