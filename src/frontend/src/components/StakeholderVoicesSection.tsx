...
const insights = [
  {
    titleKey: "stakeholder.item1.title",
    descKey: "stakeholder.item1.desc",
    icon: Award,
    color: "#6B1A1A",
  },
  {
    titleKey: "stakeholder.item2.title",
    descKey: "stakeholder.item2.desc",
    icon: Lightbulb,
    color: "#C9A84C",
  },
  {
    titleKey: "stakeholder.item3.title",
    descKey: "stakeholder.item3.desc",
    icon: Users,
    color: "#6A8F5A",
  },
  {
    titleKey: "stakeholder.item4.title",
    descKey: "stakeholder.item4.desc",
    icon: Briefcase,
    color: "#6B1A1A",
  },
  {
    titleKey: "stakeholder.item5.title",
    descKey: "stakeholder.item5.desc",
    icon: Newspaper,
    color: "#C9A84C",
  },
  {
    titleKey: "stakeholder.item6.title",
    descKey: "stakeholder.item6.desc",
    icon: Database,
    color: "#6A8F5A",
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`mt-16 transition-all duration-700 delay-600 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
          {/* Subsection Header */}
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                {t("stakeholder.planning.subtitle")}
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            ...
            <div
              className="flex items-center gap-2 px-5 py-3 rounded-full text-sm font-semibold"
              style={{
                backgroundColor: "rgba(106,143,90,0.1)",
                color: "#3A6030",
