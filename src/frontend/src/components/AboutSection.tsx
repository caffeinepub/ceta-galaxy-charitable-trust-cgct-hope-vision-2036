...
const timelineItems = [
  {
    year: "2011",
    keyTitle: "about.timeline.2010",
    keyDesc: "about.timeline.2010.desc",
    icon: Globe,
    color: "#6B1A1A",
  },
  {
    year: "2016",
    keyTitle: "about.timeline.2016",
    keyDesc: "about.timeline.2016.desc",
    icon: Target,
    color: "#8FAF7E",
  },
  {
    year: "2017",
    keyTitle: "about.timeline.2017",
    keyDesc: "about.timeline.2017.desc",
    icon: Users,
    color: "#C9A84C",
  },
  {
    year: "2026",
    keyTitle: "about.timeline.2026",
    keyDesc: "about.timeline.2026.desc",
    icon: TrendingUp,
    color: "#6B1A1A",
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Content Grid */}
        <div
          className={`grid lg:grid-cols-3 gap-8 mb-16 transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            >
              <div
                className="w-20 h-20 rounded-full mx-auto mb-4 flex items-center justify-center text-3xl font-black"
                style={{
        ...
        >
          ...
          <div className="hidden md:block relative">
            {/* Connector line */}
            <div
              className="absolute top-8 left-0 right-0 h-1 timeline-connector rounded-full"
              style={{ margin: "0 8%" }}
            />
